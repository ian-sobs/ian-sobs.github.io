  ...
  return (
    <div className="flex flex-col items-center my-0">
      ...
      {/* Ultra-sharp DOM ASCII container */}
        <pre
        aria-hidden="true"
        className={`m-0 p-0 font-mono text-[#ed695a] font-bold leading-none tracking-normal select-none overflow-x-auto overflow-y-hidden max-w-full  text-[1.55vw] md:text-[1.4vw] text-center inline-block`}
        style={{
